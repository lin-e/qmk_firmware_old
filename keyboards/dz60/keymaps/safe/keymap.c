...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = KEYMAP(
        ...
        KC_LCTL , KC_LGUI , KC_LALT , KC_SPC  , MO(_FL) , KC_SPC  , KC_RALT , KC_RGUI , MO(_LL) , KC_RCTL
    ),
    [_FL] = KEYMAP(
        ...
        _______ , M(M_FX) , _______ , _______ , _______ , _______ , KC_VOLD , KC_VOLU , KC_MUTE , KC_MPRV , KC_MNXT , KC_MPLY , _______ ,
